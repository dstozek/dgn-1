...
# +-----------------------------------
# | module altera_up_avalon_alpha_blending
# | 
set_module_property DESCRIPTION "Alpha Blending (RGBA) for DE boards"
set_module_property NAME altera_up_avalon_alpha_blending
...
set_module_property DISPLAY_NAME "Alpha Blending (RGBA)"
...
#set_module_property TOP_LEVEL_HDL_FILE Altera_UP_Avalon_Alpha_Blending.v
#set_module_property TOP_LEVEL_HDL_MODULE Altera_UP_Avalon_Alpha_Blending
...
# | files
# | 
#add_file Altera_UP_Avalon_Alpha_Blending.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
...
set_interface_property avalon_foreground_sink ASSOCIATED_CLOCK clock_reset
...
set_interface_property avalon_background_sink ASSOCIATED_CLOCK clock_reset
...
set_interface_property avalon_blended_source ASSOCIATED_CLOCK clock_reset
...
# | 
proc generate {} {
	send_message info "Starting Generation of Alpha Blending Core"
	...
	# set arguments
	set files "files=Altera_UP_Avalon_Alpha_Blending.v"
	set params ""
	set sections ""
...
#	set dest_language	[ get_generation_setting HDL_LANGUAGE ]
	...
	up_generate "$dest_dir$dest_name.v" "hdl/Altera_UP_Avalon_Alpha_Blending.v" $dest_name $params $sections
}
# | 
# +-----------------------------------
