#ifndef __ALTERA_UP_AVALON_CHARACTER_BUFFER_H__
#define __ALTERA_UP_AVALON_CHARACTER_BUFFER_H__
...
#define ALTERA_UP_AVALON_CHARACTER_BUFFER_INSTANCE(name, device)\
...
#define ALTERA_UP_AVALON_CHARACTER_BUFFER_INIT(name, device)	\
{																\
	device.x_resolution = 										\
...
#endif /* __ALTERA_UP_AVALON_CHARACTER_BUFFER_H__ */
