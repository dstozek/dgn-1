...
-- ============================================================
-- Megafunction Name(s):
-- 			ddr_sdram_component_classic_0_auk_ddr_sdram
-- ============================================================
-- Generated by DDR SDRAM Controller 9.1 [Altera, IP Toolbench 1.3.0 Build 350]
-- ************************************************************
...
ENTITY ddr_sdram_component_classic_0 IS
	PORT (
		clk	: IN STD_LOGIC;
		...
		ddr_a	: OUT STD_LOGIC_VECTOR (11 DOWNTO 0);
...
END ddr_sdram_component_classic_0;

ARCHITECTURE SYN OF ddr_sdram_component_classic_0 IS
	...
	COMPONENT ddr_sdram_component_classic_0_auk_ddr_sdram
	GENERIC (
		gMEM_TYPE	: STRING;
...
BEGIN
	...
	signal_wire15  <=  B"010";
	signal_wire16  <=  B"010";
	signal_wire17  <=  B"0000111";
	signal_wire18  <=  B"10";
	signal_wire19  <=  X"0185";
	signal_wire20  <=  X"270f";

	ddr_sdram_component_classic_0_auk_ddr_sdram_inst : ddr_sdram_component_classic_0_auk_ddr_sdram
	GENERIC MAP (
		gMEM_TYPE => "ddr_sdram",
