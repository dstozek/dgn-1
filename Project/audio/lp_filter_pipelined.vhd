...
--
-- Generated on: 2010-05-12 05:13:35
--
-- -------------------------------------------------------------
...
END lp_filter_pipelined;


----------------------------------------------------------------
--Module Architecture: filter
----------------------------------------------------------------
ARCHITECTURE rtl OF lp_filter_pipelined IS
  -- Local Functions
  -- Type Definitions
  ...
  SIGNAL sumvector1                       : sumdelay_pipeline_type(0 TO 5); -- sfix33_En31
  SIGNAL sumdelay_pipeline1               : sumdelay_pipeline_type(0 TO 5); -- sfix33_En31
  SIGNAL sumvector2                       : sumdelay_pipeline_type(0 TO 2); -- sfix33_En31
  ...
  SIGNAL sumdelay_pipeline2               : sumdelay_pipeline_type(0 TO 2); -- sfix33_En31
  SIGNAL sumvector3                       : sumdelay_pipeline_type(0 TO 1); -- sfix33_En31
  SIGNAL add_temp_3                       : signed(33 DOWNTO 0); -- sfix34_En31
  SIGNAL sumdelay_pipeline3               : sumdelay_pipeline_type(0 TO 1); -- sfix33_En31
...
BEGIN
  ...
  sumvector1(0) <= resize(product11, 33) + resize(product10, 33);

  sumvector1(1) <= resize(product9, 33) + resize(product8, 33);

  sumvector1(2) <= resize(product7, 33) + resize(product6, 33);

  sumvector1(3) <= resize(product5, 33) + resize(product4, 33);

  sumvector1(4) <= resize(product3, 33) + resize(product2, 33);

  sumvector1(5) <= resize(product1, 33);
  ...
  BEGIN
    ...
    ELSIF clk'event AND clk = '1' THEN
      IF clk_enable = '1' THEN
        sumdelay_pipeline1(0 TO 5) <= sumvector1(0 TO 5);
      END IF;
    END IF; 
  END PROCESS sumdelay_pipeline_process1;

  add_temp <= resize(sumdelay_pipeline1(0), 34) + resize(sumdelay_pipeline1(1), 34);
  sumvector2(0) <= (32 => '0', OTHERS => '1') WHEN (add_temp(33) = '0' AND add_temp(32) /= '0') OR (add_temp(33) = '0' AND add_temp(32 DOWNTO 0) = "011111111111111111111111111111111") -- special case0
      ELSE (32 => '1', OTHERS => '0') WHEN add_temp(33) = '1' AND add_temp(32) /= '1'
      ELSE (add_temp(32 DOWNTO 0));

  add_temp_1 <= resize(sumdelay_pipeline1(2), 34) + resize(sumdelay_pipeline1(3), 34);
  sumvector2(1) <= (32 => '0', OTHERS => '1') WHEN (add_temp_1(33) = '0' AND add_temp_1(32) /= '0') OR (add_temp_1(33) = '0' AND add_temp_1(32 DOWNTO 0) = "011111111111111111111111111111111") -- special case0
      ELSE (32 => '1', OTHERS => '0') WHEN add_temp_1(33) = '1' AND add_temp_1(32) /= '1'
      ELSE (add_temp_1(32 DOWNTO 0));

  add_temp_2 <= resize(sumdelay_pipeline1(4), 34) + resize(sumdelay_pipeline1(5), 34);
  sumvector2(2) <= (32 => '0', OTHERS => '1') WHEN (add_temp_2(33) = '0' AND add_temp_2(32) /= '0') OR (add_temp_2(33) = '0' AND add_temp_2(32 DOWNTO 0) = "011111111111111111111111111111111") -- special case0
  ...
  add_temp_3 <= resize(sumdelay_pipeline2(0), 34) + resize(sumdelay_pipeline2(1), 34);
  sumvector3(0) <= (32 => '0', OTHERS => '1') WHEN (add_temp_3(33) = '0' AND add_temp_3(32) /= '0') OR (add_temp_3(33) = '0' AND add_temp_3(32 DOWNTO 0) = "011111111111111111111111111111111") -- special case0
  ...
  add_temp_4 <= resize(sumdelay_pipeline3(0), 34) + resize(sumdelay_pipeline3(1), 34);
  sum4 <= (32 => '0', OTHERS => '1') WHEN (add_temp_4(33) = '0' AND add_temp_4(32) /= '0') OR (add_temp_4(33) = '0' AND add_temp_4(32 DOWNTO 0) = "011111111111111111111111111111111") -- special case0
      ELSE (32 => '1', OTHERS => '0') WHEN add_temp_4(33) = '1' AND add_temp_4(32) /= '1'
      ELSE (add_temp_4(32 DOWNTO 0));

  output_typeconvert <= (15 => '0', OTHERS => '1') WHEN (sum4(32) = '0' AND sum4(31) /= '0') OR (sum4(32) = '0' AND sum4(31 DOWNTO 16) = "0111111111111111") -- special case0
      ELSE (15 => '1', OTHERS => '0') WHEN sum4(32) = '1' AND sum4(31) /= '1'
      ELSE (resize(shift_right(sum4(32) & sum4(31 DOWNTO 0) + ( "0" & (sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16) & NOT sum4(16))), 16), 16));
