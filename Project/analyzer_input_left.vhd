...
end entity analyzer_input_left;

architecture rtl of analyzer_input_left is
...
begin
	...
	analyzer_input_left : component analyzer_input
		port map (
			clk      => clk,      --        clock.clk
			reset    => reset,    --             .reset_n
...
end architecture rtl; -- of analyzer_input_left
